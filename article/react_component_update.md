...
![组件结构](../resource/react_state_update/p1.png)
    ...
    return (
      <div className="container">
        <div onClick={this.update}>
          {this.state.name} (father:{this.props.father})
        </div>
        <div className="children">
...
![结果](../resource/react_state_update/p2.png)

如果我们点击组件 `C1` 的标题，组件 `C1` 将会更新，`C1` 名字后面增加了一串随机数字，同时它的子组件 `C3` 的内容也更新了，结果如下：

![结果](../resource/react_state_update/p3.png)
...
![结果](../resource/react_state_update/p4.png)
...
![组件结构2](../resource/react_state_update/p2_1.png)
...
![输出结果2_2](../resource/react_state_update/p2_2.png)

那么点击按钮 `update name` 会有什么结果呢？
当然，页面上，组件 `Root` 都名字会更新，并且控制台会输出和之前一样的内容

![输出结果2_3](../resource/react_state_update/p2_3.png)
...
![修改3_1](../resource/react_state_update/p3_1.png)

再次点击按钮 `update nothing` 和 `update name`，控制台输出分别为：

![update nothing 结果](../resource/react_state_update/p3_2.png)

![update name 结果](../resource/react_state_update/p3_3.png)
...
![修改 2](../resource/react_state_update/p4_1.png)
...
![update nothing 结果](../resource/react_state_update/p4_2.png)

![update name 结果](../resource/react_state_update/p4_3.png)
